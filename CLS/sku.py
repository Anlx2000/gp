...
class SKNet(nn.Module):
    def __init__(self, class_num):
        ...
        self.stage_1 = nn.Sequential(
            SKUnit(64, 256, 224, 2, 8, 2, stride=2),
            nn.ReLU(),
            SKUnit(256, 256, 112, 2, 8, 2),
            nn.ReLU(),
            SKUnit(256, 256, 112, 2, 8, 2),
            nn.ReLU()
        )  # 32x32
        self.stage_2 = nn.Sequential(
            SKUnit(256, 512, 112, 2, 8, 2, stride=2),
            nn.ReLU(),
            SKUnit(512, 512, 56, 2, 8, 2),
            nn.ReLU(),
            SKUnit(512, 512, 56, 2, 8, 2),
            nn.ReLU()
        )  # 16x16
        self.stage_3 = nn.Sequential(
            SKUnit(512, 1024, 56, 2, 8, 2, stride=2),
            nn.ReLU(),
            SKUnit(1024, 1024, 28, 2, 8, 2),
            nn.ReLU(),
            SKUnit(1024, 1024, 28, 2, 8, 2),
            nn.ReLU()
        )  # 8x8
